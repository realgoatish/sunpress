<script lang="ts">
	...
	import type { PageData } from '../../catering-menu/$types';
	import { previewSubscription } from '$lib/config/sanity';
	import { menuCateringPagePreviewQuery } from '$lib/config/sanity/queries';

	export let data: PageData;

	$: ({ initialData, previewMode, slug, localBusiness } = data);

	$: test = previewSubscription(menuCateringPagePreviewQuery, {
		params: { slug },
		initialData,
